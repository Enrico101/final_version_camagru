<?php
   ...
   // include ("delete_info.php");
    ...
    if (isset($_POST['comment']))
    {
        ...
        //$image = $_GET['pic'];
        /*$result_sets = $db->prepare("SELECT image FROM camagru_users.user_images WHERE Image_ID=?");
    ...
    //$img = $_GET['pic'];
    /*$result_sets = $db->prepare("SELECT image FROM camagru.images WHERE Image_ID=?");
    $result_sets->bindValue(1, $_GET['pic']);
    $result_sets->execute();
    ...
    if (isset($_POST['like']))
    {
        ...
        //$image = $_GET['pic'];
        /*$result_sets = $db->prepare("SELECT image FROM camagru.images WHERE ID=?");
        $result_sets->bindValue(1, $_GET['pic']);
        $result_sets->execute();
...
<html>
    ...
    {
        //$image = $_GET['pic'];
        //$result_01 = $db->prepare("SELECT Comment, User_ID FROM camagru.comments WHERE Image_ID=?");
