    ...
    <body>
        ...
        <form action="check.php" method="post">
            ...
            <fieldset class="border">
                ...
                <p id="exists">Username already exists</p>
                <p><input class="bs" style="border-color: red;" type="text" name="Username" Placeholder=" Enter Username" pattern="[^]{1,}" title="Username is not valid" required></p> 
                ...
                <P><input class="bs" type="email" name="Email" pattern="[a-zA-Z0-9]+@+[a-zA-Z]+\.{1, }" placeholder="Enter Email" required></P>
