<?php
    ...
    $q_three = "CREATE TABLE IF NOT EXISTS `Camagru`.`Likes` ( `User_ID` INT UNIQUE , `Image_ID` INT, FOREIGN KEY (`User_ID`) REFERENCES Users(User_ID), FOREIGN KEY (`Image_ID`)REFERENCES Images(Image_ID));";
