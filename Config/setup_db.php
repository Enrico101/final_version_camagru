<?php
    ...
    $q_one = "CREATE TABLE IF NOT EXISTS `Camagru`.`Users` ( `User_ID` INT NOT NULL AUTO_INCREMENT , `Username` VARCHAR(255) NOT NULL , `Password` VARCHAR(1000) NOT NULL , `Email` VARCHAR(60) NOT NULL , `Token` VARCHAR(20) NOT NULL , `Status` VARCHAR(20) NOT NULL , `Connection` VARCHAR(20) NOT NULL , `Notifications` VARCHAR(20) NOT NULL , PRIMARY KEY (`User_ID`));";
    $q_two = "CREATE TABLE IF NOT EXISTS `Camagru`.`Images` ( `Image_ID` INT NOT NULL AUTO_INCREMENT , `User_ID` INT, `Image` VARCHAR(1000) NOT NULL , PRIMARY KEY (`Image_ID`), FOREIGN KEY (`User_ID`) REFERENCES Users(`User_ID`));";
